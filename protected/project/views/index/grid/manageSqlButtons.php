...
<div class="actions">
    <?php if ($table->isAllowExecute($row['command_type'], $row['argument'])): ?>
        <div class="btn-group-vertical exec">
            <?php if ($db): ?>
                <div class="btn-group">
                    <a href="<?= $execLink->appendCustomModelAttrs($execSqlForm, ['db' => $db]) ?>"
                       class="btn btn-default btn-xs" data-modal="">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php foreach ($databases as $database): ?>
                        <li>
                            <a href="<?= $execLink->appendCustomModelAttrs($execSqlForm, ['db' => $database]) ?>"
                               data-modal="">
                                <?= $database ?>
                            </a>
                        </li>
    ...
    <?php if ($table->isAllowExplain($row['command_type'], $row['argument'])): ?>
        <div class="btn-group-vertical explain">
            <?php if ($db): ?>
                <div class="btn-group">
                    <a href="<?= $explainLink->setParams(['db' => $db]) ?>" class="btn btn-default btn-xs"
                       data-modal="">
